...
def run_tests():
    ...
    place_collection = PlaceCollection(Place)
    ...
    print("Test priority sorting: ")
    place_collection.sort_priority(place_collection.places)
    print(place_collection)

    """Test aplha sorting"""
    print("Test aplha sorting:")
    place_collection.sort_alpha(place_collection.places)
    print(place_collection)

    """Test visited status sorting"""
    print("Test visited status sorting:")
    place_collection.sort_visited(place_collection.places)
    print(place_collection)
    # TODO: Test saving places (check CSV file manually to see results)
    print("Test saving: ")
    place_collection.save_file("place.csv")
